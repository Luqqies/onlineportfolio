...
// Video resume popup modal
// Paste the YouTube video ID here once the video is published.
const VIDEO_RESUME_ID = '';
...
function openVrModal() {
  ...
  vrFrame.src = `https://www.youtube-nocookie.com/embed/${VIDEO_RESUME_ID}?autoplay=1&rel=0`;
